...
export class Backend implements backendInterface {
    ...
    async fetchAiResponse(arg0: string, arg1: Array<Header>, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAiResponse(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPredefinedPath(arg0: bigint): Promise<CareerPath> {
        if (this.processError) {
            try {
                const result = await this.actor.getPredefinedPath(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuizResult(arg0: Principal): Promise<QuizResult> {
        if (this.processError) {
            try {
    ...
    async getUserAnswers(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAnswers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasQuizResults(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasQuizResults();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAnswers(arg0: Array<QuizAnswer>, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAnswers(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
